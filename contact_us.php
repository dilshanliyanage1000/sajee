...
<body>
    ...
    <div class="body_content">
        ...
        <div style="background-color: rgb(255, 243, 220); padding-top: 10px; padding-bottom: 40px;">
            ...
            <br>
            <form id="inquiry_form" action="#" style="text-align: left; padding-left: 100px; padding-right: 30px;">
                <div class="row">
                    <div style="width: 10%;">
                ...
                <div class="row">
                    ...
                    <div style="width: 30%;">
                        <input type="text" name="inq_email" id="inq_email" class="input_text_style" placeholder="Enter Email Address">
                    </div>
                    <div style="width: 10%;"></div>
                    <div style="width: 10%;">
                    ...
                    <div style="width: 30%;">
                        <input type="text" name="inq_contact" id="inq_contact" class="input_text_style" placeholder="Enter Contact Number" required>
                    </div>
                </div>
                <div class="row">
                    <div style="width: 10%;">
                ...
                <div class="row">
                    ...
                    <div style="width: 80%; text-align: right;">
                        <button id="form_submit_button" type="button">
...
<script>
    $(document).ready(function() {
        ...
        $("#form_submit_button").click(function() {
            ...
            $inq_email = $("#inq_email").val();
            $inq_contact = $("#inq_contact").val();
            $inq_subject = $("#inq_subject").val();
            $inq_message = $("#inq_message").val();

            $.post("routes/add_inquiry.php", {
